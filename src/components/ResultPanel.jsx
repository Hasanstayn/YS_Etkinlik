      ...
      <div className="glass-panel rounded-3xl p-6 md:p-10 border-t-8 border-indigo-500 bg-white shadow-lg">
        <div className="flex justify-between items-center mb-6 border-b border-slate-200 pb-4 flex-wrap gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {/* Yazıları Kopyala Butonu */}
            <button
              onClick={onCopyOnlyText}
              className="flex items-center gap-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-lg text-sm font-bold hover:bg-emerald-200 transition-all active:scale-95"
              title="Tablolardaki başlıkları çöpe atıp, sadece cevap yazılarını kopyalar."
            >
            ...
            {/* Formatlı Kopyala Butonu */}
            <button
              onClick={onCopyForWord}
              className="flex items-center gap-2 bg-slate-100 text-slate-700 px-4 py-2 rounded-lg text-sm font-bold hover:bg-slate-200 transition-all active:scale-95"
              title="Şablonu tabloları ve renkleriyle beraber panoya kopyalar (Boş Word'e yapıştırmak için)."
            >
              Formatlı Kopyala
            </button>
          </div>
